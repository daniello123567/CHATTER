...
function footer() {
  return (
    <div className={`${inter.className}  bg-black py-[4em] px-[1em] w-full h-[34.0625em] lg:h-[40.3em] rounded-[2.5em] mx-auto`}>
      ...
      <div className="px-[1em] mx-auto mt-[1.5em] text-[1.125em]  rounded-full bg-white w-[max-content] py-[.7em]">Get Started</div>
      <div className=" w-[max-content] mt-[7em] flex-wrap text-center mx-auto flex gap-[1em]">
        ...
        <Link href='/signIn' className="text-[0.875em] text-white">get started</Link>
        <Link href='/signUp' className="text-[0.875em]  text-white">Become an author</Link>
      </div>
