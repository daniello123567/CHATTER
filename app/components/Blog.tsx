...
function Blog({ title, thumbnail, content,name,created_at }: { created_at:string,title: string,name:string, thumbnail: string, content: string }
) {
  return (
    <div className="px-[2em] pt-[2em] lg:px-[15em]">
      <BackToBlogBtn/>
      ...
      <div dangerouslySetInnerHTML={{ __html: content }} className={`${inter2.className} mt-3 text-[1.25em] prose`}>
