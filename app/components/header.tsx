...
function Header() {
  ...
  return (
    ...
    <div className='flex gap-x-[1em]'>
      {pathname!=='/dashboard' &&<Link className='text-[0.75em] border border-[#282828] px-2 py-2 hover:bg-[#282828] hover:text-white transform transition duration-75 ease-in rounded-full ' href='/dashboard'>Dashboard</Link>}
      <UserButton/>
</div>
    }
