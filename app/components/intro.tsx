  ...
  return (
    <div className={`${inter.className} gap-[1.5em] flex flex-col px-[1em]`}>
      <div className='w-full lg:h-[30.5em] lg:w-[38.46875em] px-[1em] py-[1.2em] rounded-[2em] bg-[#F2F4F7] h-[29.9em]'>
        ...
        <Image className="w-[90%]  md:object-contain shadow-lg  mt-[.9em] mx-auto ro h-[70%] object-cover" alt={`image of ${nameOfFeature}`} src={imageOfFeature} width={400} height={50} />
